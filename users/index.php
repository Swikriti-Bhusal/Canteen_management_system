    ...
    <section class="hero">
        <div class="container">
            <div class="hero-content">
                ...
                <div class="hero-buttons">
                    <a href="../users/menu.php" class="btn btn-primary">Order Now <i class="fas fa-arrow-right"></i></a>
                    <a href="../users/aboutus.php" class="btn btn-outline">Learn More</a>
                </div>
            </div>
        ...
        <div class="feature-cards">
            <div class="feature-card">
                ...
                <a href="menu.html" class="btn btn-outline">View Menu <i class="fas fa-chevron-right"></i></a>
            </div>
            <div class="feature-card">
                <div class="feature-icon">
                    <i class="fas fa-shopping-cart"></i>
                ...
                <a href="menu.html" class="btn btn-primary">Order Now <i class="fas fa-chevron-right"></i></a>
            </div>
    </section>
    <footer>
        <div class="container">
